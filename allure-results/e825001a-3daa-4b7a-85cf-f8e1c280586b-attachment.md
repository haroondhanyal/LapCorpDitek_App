...
- generic [ref=e1]:
  ...
  - dialog [ref=e147]:
    - generic [ref=e148]:
      - heading [level=1] [ref=e149]: Protected Information Access
      - heading [level=6] [ref=e150]: This user is trying to access protected patient information
    - generic [ref=e151]:
      - generic [ref=e152]:
        - paragraph [ref=e153]: "User Id: 87"
        - paragraph [ref=e154]: "Username: rharoon@medzah.com"
        - paragraph [ref=e155]: "Access Date: December 29, 2025 at 08:48 PM"
      - generic [ref=e156]:
        - heading [level=6] [ref=e157]: Please select a reason for viewing patient details
        - generic [ref=e158]:
          - combobox [expanded] [ref=e159] [cursor=pointer]
          - textbox
          - img
          - group
        - paragraph [ref=e160]: Please select a reason to proceed
    - generic [ref=e161]:
      - button [disabled]: View Patient Details
  - listbox [ref=e164]:
    - option "To Verify Order" [active] [ref=e165] [cursor=pointer]: To Verify Order
    - option "To Update Records" [ref=e166] [cursor=pointer]
    - option "Authorized User Request" [ref=e167] [cursor=pointer]
    - option "Other Purpose" [ref=e168] [cursor=pointer]
```